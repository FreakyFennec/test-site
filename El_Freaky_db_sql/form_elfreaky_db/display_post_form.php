    ...
    <div id="container">
        ...
        <main>
            <article>
                ...
                <?php
                    // Work variables
                    $postInput = array("Titre", "Contenu", "Date", "Image", "Alt img");
                    

                    function displayPostForm($postInput) {

                        echo '<form method="post" action="controller.php"><fieldset id="fieldsetText"><div>';

                        foreach($postInput as $postInput) {

                            echo '
                                <label id="inputTextLabel" for="#">' .$postInput. '</label>
