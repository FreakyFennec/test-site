...
*/
	if (inputSimplePast == randVerb.simplePast && inputPastParticipe == randVerb.pastParticipe) {
		...
		document.getElementById('simpleP').innerHTML = '<div class="corrected-verb" type="text" id="simplePast">' + randVerb.simplePast + '</div><span id="zoneCheckImages"><img src="assets/img/green-check-mark-25x25.png" alt="green-check-mark" id="checkImages"></span>';
		document.getElementById('pastP').innerHTML = '<div class="corrected-verb" type="text" id="pastParticipe">' + randVerb.pastParticipe + '</div><span id="zoneCheckImages"><img src="assets/img/green-check-mark-25x25.png" alt="green-check-mark" id="checkImages"></span>';
		...
		document.getElementById('infinit').innerHTML = '<div class="corrected-verb" type="text" id="infinitive">' + randVerb.Infinitive + '</div>';
		document.getElementById('simpleP').innerHTML = '<div class="corrected-verb" type="text" id="simplePast">' + randVerb.simplePast + '</div><span id="zoneCheckImages"><img src="assets/img/red-cross-mark-25x25.png" alt="red-cross-mark" id="checkImages"></span>';
		document.getElementById('pastP').innerHTML = '<div class="corrected-verb" type="text" id="pastParticipe">' + randVerb.pastParticipe + '</div><span id="zoneCheckImages"><img src="assets/img/green-check-mark-25x25.png" alt="green-check-mark" id="checkImages"></span>';
		...
		document.getElementById('infinit').innerHTML = '<div class="corrected-verb" type="text" id="infinitive">' + randVerb.Infinitive + '</div>';
		document.getElementById('simpleP').innerHTML = '<div class="corrected-verb" type="text" id="simplePast">' + randVerb.simplePast + '</div><span id="zoneCheckImages"><img src="assets/img/green-check-mark-25x25.png" alt="green-check-mark" id="checkImages"></span>';
		document.getElementById('pastP').innerHTML = '<div class="corrected-verb" type="text" id="pastParticipe">' + randVerb.pastParticipe + '</div><span id="zoneCheckImages"><img src="assets/img/red-cross-mark-25x25.png" alt="red-cross-mark" id="checkImages"></span>';
		...
		document.getElementById('simpleP').innerHTML = '<div class="corrected-verb" class="col-12" type="text" id="simplePast">' + randVerb.simplePast + '</div><span id="zoneCheckImages"><img src="assets/img/red-cross-mark-25x25.png" alt="red-cross-mark" id="checkImages"></span>';
		document.getElementById('pastP').innerHTML = '<div class="corrected-verb" class="col-12" type="text" id="pastParticipe">' + randVerb.pastParticipe + '</div><span id="zoneCheckImages"><img src="assets/img/red-cross-mark-25x25.png" alt="red-cross-mark" id="checkImages"></span>';
