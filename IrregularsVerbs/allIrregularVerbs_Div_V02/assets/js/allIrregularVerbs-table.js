...
function displayAllIrregularVerb() {
	...
	document.getElementById('tbody').innerHTML = ''; // Efface le contenu de tbody
	...
	function objectVerb(arrayVerb) {
        ...
        for (let i = 0; i < arrayVerb.length; i++) {
            ...
            let verb = arrayVerb[i];

			/*console.log(verb);*/	
		}
		return arrayVerb; // Return un objet contenant les éléments d'un verbe.
	}
...
console.log(verb);*/
	...
	function displayRandVerb(verb) {		
		...
		for (let i in verb) { // Boucle sur l'objet verb
			...
			'<tr id="contentRow"><td id="infinitive" height="33px">' + values[0] + 
			'</td><td id="simplePast" height="33px">' + values[1] + 
			'</td><td id="pastParticipe" height="33px">' + values[2] + 
			'</td><td id="translation" height="33px">' + values[3] + 
			'</td></tr>';
		}
