...
function displayIrregularVerb() {
	...
	let arrayVerb = [{'Infinitive' : 'abide', 'Simple past' : 'abode', 'Past participe' : 'abode', 'Translation Fr' : 'respecter / se conformer à'},
					...
					{'Infinitive' : 'spend', 'Simple past' : 'spent', 'Past participe' : 'spent', 'Translation Fr' : 'dépenser / passer du tenses'},
	...
	function randomVerb(arrayVerb) {
		...
		let rand = Math.floor(Math.random() * arrayVerb.length);
		let randVerb = arrayVerb[rand];
		
		return randVerb;
	}/**/
	let randVerb = randomVerb(arrayVerb);
